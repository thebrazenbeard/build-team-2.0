...
from ._store_types import OperationResult, ValidationError
...
class RecordCommandsMixin:
    def add_claim(
        ...
        *,
        ...
        record = build_record(
            ...
            provenance={"attributable_to": attributable_to},
            lineage_key=claim_key,
    ...
    def add_assessment(
        ...
        *,
        ...
        if disposition not in {"ACCEPTED", "DISPUTED", "REJECTED", "UNVERIFIED"}:
            raise ValidationError("Invalid assessment disposition")
        if self._record_type(claim_id) != "Claim":
